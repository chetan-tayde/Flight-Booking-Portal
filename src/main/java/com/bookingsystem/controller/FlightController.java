...
public class FlightController {
	...
	@GetMapping("/byAirport")
	public ResponseEntity<List<Map<String,Object>>> searchFlightByAirport(@RequestParam String airportSourceName, @RequestParam String aiportDestinationName){
		List<Map<String,Object>> flights = flightService.searchFlights(airportSourceName, aiportDestinationName);
		return ResponseEntity.ok(flights);
	}
